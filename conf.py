...
BLOG_AUTHOR = "Alvaro Segura Del Barco"  # (translatable)
BLOG_TITLE = "Mi Sitio"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://rngkll.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://rngkll.github.io/"
BLOG_EMAIL = "alvarosb@gmail.com"
BLOG_DESCRIPTION = "Varas ahí"  # (translatable)
